  ...
  useEffect(() => {
    const fetchDonations = async () => {
      ...
      try {
        ...
        // ID kontrolü
        const donationsWithoutId = response.data.filter(donation => !donation.id)
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} key="search-icon" />
              <Input
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="READY_FOR_PICKUP" key="status-READY_FOR_PICKUP">Teslim Almaya Hazır</SelectItem>
                  ...
                  <SelectItem value="RECEIVED_BY_RECIPIENT" key="status-RECEIVED_BY_RECIPIENT">Alıcı Tarafından Alındı</SelectItem>
