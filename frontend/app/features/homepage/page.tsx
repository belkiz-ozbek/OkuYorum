    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-100/20 via-pink-100/20 to-purple-100/20 rounded-2xl -z-10 blur-3xl" />
              ...
              <CarouselContent className="-ml-2 md:-ml-4">
                {[
                  ...
                  <CarouselItem key={index} className="pl-2 md:pl-4 md:basis-1/3 lg:basis-1/5">
                    <motion.div 
                      className="group relative aspect-[2/3] overflow-hidden rounded-xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500"
                      whileHover={{ y: -5 }}
                    >
                      <Image
                        src={book.coverUrl}
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full transition-transform duration-500 group-hover:translate-y-0">
                        <h3 className="font-medium text-base text-white mb-1 line-clamp-1">{book.title}</h3>
                        <p className="text-sm text-white/90">{book.author}</p>
                      </div>
                      {/* Hover effect overlay */}
                      <div className="absolute inset-0 bg-purple-600/5 opacity-0 group-hover:opacity-100 mix-blend-overlay transition-opacity duration-500" />
                    </motion.div>
                  </CarouselItem>
                ))}
              </CarouselContent>
              <div className="hidden md:block">
                <CarouselPrevious className="-left-12 h-12 w-12 bg-white/10 hover:bg-white/20 border-0 text-primary" />
                <CarouselNext className="-right-12 h-12 w-12 bg-white/10 hover:bg-white/20 border-0 text-primary" />
              </div>
            </Carousel>
          </div>
        </motion.div>
