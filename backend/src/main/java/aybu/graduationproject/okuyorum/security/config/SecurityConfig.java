    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/kiraathanes/*/ratings").hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/kiraathanes/*/ratings").permitAll()
                .requestMatchers("/api/kiraathane-ratings/**").hasAnyRole("USER", "ADMIN")
